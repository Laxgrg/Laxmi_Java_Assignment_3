...
public class StockUp {
  ...
  public static void main(String[] args) {
    ...
    System.out.println("\u001B[92m" + "How much money are you starting with?\n");
    ...
    while(!isDone) {
      ...
      switch (choice) {
        ...
        case 3: // add funds
          ...
          System.out.printf("\u001B[94m" + "New balance: $%.2f\n", portfolio.getBalance());
          break;
        case 4: // withdraw funds
          double amountWithdrawn = validator.fundWithDrawValidation(ink, input, portfolio.getBalance());
          portfolio.fundsWithdraw(amountWithdrawn);
          // print the new balance
          System.out.printf("\u001B[92m" + "New balance: $%.2f\n", portfolio.getBalance());
          break;
        case 5:
          isDone = !isDone;
          break;
